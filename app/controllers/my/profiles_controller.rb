    ...
    def user_params
      params.require(:my_profile_form).permit(
        user_attributes: [
          ...
          representative_ids: [],
          educations_attributes: [:location, :start_month, :start_year, :end_month, :end_year, :institution, :education_level, :education_grade, :field_of_study, :education_description, :state, :country, :id, :_destroy],
          ...
          exhibitions_attributes: [:pdf_filename, :location, :record_start_year, :record_end_year, :start_month, :end_month, :start_year, :end_year, :title, :category, :venue_id, :state, :country, :pdf_url, :id, :_destroy],
          bibliographies_attributes: [:pdf_filename, :location, :title, :publication_title, :publisher, :edition, :author, :page_number, :source_type, :link, :participation, :publication_city, :publication_country, :editor, :issue, :pdf_url, :attachment_url, :month, :year, :id, :_destroy],
          publications_attributes: [:pdf_filename, :location, :participation, :category, :title, :publication_title, :country, :state, :day, :month, :year, :publisher, :edition, :editor, :issue, :page_numbers, :link, :pdf_url, :attachment_url, :id, :_destroy],
