    ...
    def user_params
      params.require(:my_profile_form).permit(
        user_attributes: [
          ...
          representative_ids: [],
          educations_attributes: [:start_month, :start_year, :end_month, :end_year, :institution, :education_level, :education_grade, :field_of_study, :education_description, :state, :country, :id, :_destroy],
