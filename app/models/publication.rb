class Publication < ActiveRecord::Base
  ...
  validates :category, :title, :year, presence: true, unless: :attachment_is_present?
  validates :publication_title, presence: true, if: -> { (category == "article" || category == "essay") && !attachment_is_present? }
