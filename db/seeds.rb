...
user_admin = User.create!(email: 'admin@pan.com', password: '123123123', password_confirmation: '123123123', first_name: 'PAN', last_name: 'Admin', title: 'mr', role: :admin, gender: "male", based_location: "London, United Kingdom", date_of_birth: '1990-09-09', current_status: "Seeking Representation", active: true, email_confirmed: true, confirmation_token: nil)
...
user_artist1 = User.create(email: 'user@pan.com', password: '123123123', password_confirmation: '123123123', first_name: 'Mario', last_name: 'Mariana', title: 'mr', role: :artist, date_of_birth: '1990-09-09',
  ...
  instagram_link: "www.ronaldhunt.com", twitter_link: "www.ronaldhunt.com", from_exhibit_date: '2015-11-01', to_exhibit_date: '2015-11-01', gender: "male", based_location: "London, United Kingdom", active: true, email_confirmed: true, confirmation_token: nil) do |user|
  ...
  user.artworks.build(image_url: "https://cdn.filepicker.io/api/file/6z4UHymTNegoMddWi3ly",
    ...
    year: 2014,
    art_type: "Landscape",
    medium_ids: Medium.all.collect(&:id),
    subject_ids: Subject.all.collect(&:id),
...
user_artist2 = User.create!(email: 'artist@pan.com', password: '123123123', password_confirmation: '123123123', first_name: 'Famous', last_name: 'Artist', title: 'dr', role: :artist, date_of_birth: '1990-09-09',
  ...
  instagram_link: "", twitter_link: "www.ronaldhunt.com", from_exhibit_date: '2015-11-01', to_exhibit_date: '2015-11-01', gender: "male", based_location: "London, United Kingdom", active: true, email_confirmed: true, confirmation_token: nil) do |user|
...
', from_exhibit_date: '2015-11-01', to_exhibit_date: '2015-11-01', gender: "male", based_location: "London, United Kingdom", active: true, email_confirmed: true, confirmation_token: nil) do |user|
